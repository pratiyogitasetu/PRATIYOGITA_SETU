...
const SyllabusSection = () => {
  ...
  return (
    <div className={`flex-1 ${leftMargin} mr-0 md:mr-4 flex flex-col h-full overflow-hidden pt-[60px] md:pt-[64px] pl-2 pr-2 pb-2 transition-[margin-left] duration-300 ease-in-out`}>
      {/* Main Container */}
