    ...
    >
      <div className="relative flex w-full max-w-sm items-center bg-[#18181b]/80 backdrop-blur-md p-1 rounded-2xl border border-white/10 shadow-xl pointer-events-auto">
        ...
        <button
          ...
          className={`relative z-10 flex-1 flex items-center justify-center gap-1.5 py-1.5 text-xs font-bold rounded-xl transition-colors duration-200 ${
            mobileActiveTab === 'pyq' ? 'text-white' : 'text-gray-300 hover:text-white'
          }`}
        >
        ...
        <button
          ...
          className={`relative z-10 flex-1 flex items-center justify-center gap-1.5 py-1.5 text-xs font-bold rounded-xl transition-colors duration-200 ${
            mobileActiveTab === 'chat' ? 'text-white' : 'text-gray-300 hover:text-white'
          }`}
        >
