...
const Footer = () => {
  ...
  return (
    <footer className="w-full relative overflow-hidden" style={{background: 'linear-gradient(to top, rgba(228,87,46,0.15) 0%, rgba(43,30,23,0.6) 60%, transparent 100%)'}}>
      {/* Decorative top divider line */}
      <div className="w-full h-px" style={{background: 'linear-gradient(90deg, transparent 0%, rgba(228,87,46,0.5) 30%, rgba(232,216,195,0.4) 50%, rgba(228,87,46,0.5) 70%, transparent 100%)'}} />
      <div className="max-w-5xl mx-auto px-4 py-4 sm:px-6 sm:py-6 md:py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          ...
          <div>
            <div className="inline-block bg-[#E4572E] rounded-lg px-2.5 py-0.5 mb-3">
              <h3 className="text-xs sm:text-sm font-semibold text-[#FBF6EE]">
          ...
          <div>
            ...
            <div className="mb-3">
              <Link to="/" className="flex items-center gap-2 mb-1.5">
                ...
                <span className="text-sm sm:text-base font-bold text-[#FBF6EE]">Pariksha Setu</span>
              </Link>
              <p className="text-sm text-[#E8D8C3] leading-relaxed text-justify">
                {language === "en"
            ...
            <div className="flex flex-wrap items-center gap-1.5 mb-3">
              <span className="text-sm text-[#E8D8C3]/80">
                {language === "en" ? "For help and support:" : "सहायता के लिए:"}
              </span>
              <a href="mailto:askparikshasetu@gmail.com" className="text-[#E4572E] hover:underline text-sm">
            ...
            <div className="flex flex-wrap gap-2.5 sm:gap-3 mb-3">
              <a href="mailto:askparikshasetu@gmail.com" className="text-[#E8D8C3] hover:text-[#E4572E] transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
                  <path d="M1.5 8.67v8.58a3 3 0 003 3h15a3 3 0 003-3V8.67l-8.928 5.493a3 3 0 01-3.144 0L1.5 8.67z" />
                  <path d="M22.5 6.908V6.75a3 3 0 00-3-3h-15a3 3 0 00-3 3v.158l9.714 5.978a1.5 1.5 0 001.572 0L22.5 6.908z" />
                </svg>
              </a>
              <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="text-[#E8D8C3] hover:text-[#E4572E] transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
                  <path d="M20.5 2h-17A1.5 1.5 0 002 3.5v17A1.5 1.5 0 003.5 22h17a1.5 1.5 0 001.5-1.5v-17A1.5 1.5 0 0020.5 2zM8 19H5v-9h3zM6.5 8.25A1.75 1.75 0 118.3 6.5a1.78 1.78 0 01-1.8 1.75zM19 19h-3v-4.74c0-1.42-.6-1.93-1.38-1.93A1.74 1.74 0 0013 14.19a.66.66 0 000 .14V19h-3v-9h2.9v1.3a3.11 3.11 0 012.7-1.4c1.55 0 3.36.86 3.36 3.66z" />
                </svg>
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-[#E8D8C3] hover:text-[#FBF6EE] transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="text-[#E8D8C3] hover:text-[#E4572E] transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
            ...
            <div className="flex flex-wrap gap-x-4 gap-y-1.5 text-xs">
              ...
              <Link to="/contribution" className="text-[#E8D8C3] hover:text-[#E4572E] hover:underline transition-colors">
                {language === "en" ? "Contribution" : "योगदान"}
              </Link>
              <Link to="/contact" className="text-[#E8D8C3] hover:text-[#E4572E] hover:underline transition-colors">
        ...
        {/* Bottom bar */}
        <div className="border-t border-[#E4572E]/30 mt-4 pt-2">
          <div className="flex flex-col sm:flex-row justify-between items-center text-[#E8D8C3]/80 text-[10px] sm:text-xs">
            <div>{language === "en" ? "Made with ❤️ for Aspirants" : "उम्मीदवारों के लिए ❤️ से बनाया गया"}</div>
            <div className="mt-1 sm:mt-0">
              © {currentYear} |{" "}
              <Link to="/privacy-policy" className="underline hover:text-[#E4572E]">
                {language === "en" ? "Privacy Policy" : "गोपनीयता नीति"}
              </Link>{" "}|{" "}
              <Link to="/terms-and-conditions" className="underline hover:text-[#E4572E]">
                {language === "en" ? "Terms & Conditions" : "नियम और शर्तें"}
              </Link>{" "}|{" "}
              <Link to="/refund-policy" className="underline hover:text-[#E4572E]">
