    ...
    <footer className="w-full relative overflow-hidden" style={{background: 'linear-gradient(to top, rgba(228,87,46,0.15) 0%, rgba(43,30,23,0.6) 60%, transparent 100%)'}}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 sm:py-8 md:py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div>
            <div className="inline-block bg-[#E4572E] rounded-lg px-3 py-1 mb-5">
              <h3 className="text-sm sm:text-base font-semibold text-[#FBF6EE]">
          ...
          <div>
            ...
            {/* Connect With Us */}
            <div className="inline-block bg-[#E4572E] rounded-lg px-3 py-1 mb-4">
              <h3 className="text-sm sm:text-base font-semibold text-[#FBF6EE]">
        ...
        {/* Bottom bar */}
        <div className="border-t border-[#E4572E]/30 mt-6 pt-3">
          <div className="flex flex-col sm:flex-row justify-between items-center text-[#E8D8C3]/80 text-xs sm:text-sm">
