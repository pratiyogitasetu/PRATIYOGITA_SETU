...
const FloatCard = ({ value, suffix, label, delay, floatDelay, active, style }) => {
  ...
  return (
    <motion.div
      className="absolute z-20 flex flex-col bg-[rgba(30,30,36,0.85)] border border-white/10 rounded-2xl backdrop-blur-md px-3 py-2 sm:px-4 sm:py-3 shadow-lg"
      style={style}
    ...
    >
      <span className="text-base sm:text-lg lg:text-xl font-extrabold text-[#FBF6EE] leading-none tabular-nums">
        {count}{suffix}
      </span>
      <span className="text-[9px] sm:text-[10px] font-medium text-[#E8D8C3]/70 mt-0.5 leading-tight">
        {label}
      </span>
    </motion.div>
  );
...
const MapWithStats = ({ active }) => {
  ...
  return (
    <div className="relative w-full max-w-[85%] sm:max-w-[75%] lg:max-w-[80%] mx-auto">
      {/* Map SVG */}
      ...
      <FloatCard value={3000} suffix="+" label="Competitive Exams"
        style={{ top: "12%",  left: "-5%"  }} delay={0.5} floatDelay={0.0} active={active} />
      <FloatCard value={10}   suffix="M+" label="Aspirants / year"
        style={{ top: "12%",  right: "-5%" }} delay={0.6} floatDelay={0.8} active={active} />
      <FloatCard value={6}    suffix="+"  label="Exam Domains"
        style={{ bottom: "10%", left: "-5%"  }} delay={0.7} floatDelay={1.6} active={active} />
      <FloatCard value={100}  suffix="%"  label="AI-Powered"
        style={{ bottom: "10%", right: "-5%" }} delay={0.8} floatDelay={2.4} active={active} />
    </div>
  );
};
...
const ProblemSection = () => {
  ...
  return (
    <section ref={sectionRef} className="relative py-6 sm:py-4 px-4 sm:px-6 lg:px-8">
      <div className="relative rounded-4xl overflow-hidden mx-auto bg-[#FBF6EE] max-w-screen-2xl">
        <div className="relative z-10 py-6 sm:py-6 px-4 sm:px-8 lg:px-12">
          ...
          >
            <span className="inline-block text-xs font-bold uppercase tracking-[0.2em] text-[#E4572E] border border-[#E4572E]/40 rounded-full px-4 py-1 mb-3 bg-[#E4572E]/8">
              The Problem
            </span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#2B1E17] leading-tight flex flex-col items-center gap-1 sm:block sm:gap-0 tracking-tight">
              <span>10+ Million Aspirants.</span>
              {" "}
              <span className="text-[#E4572E] ml-1">
                One Broken System.
              </span>
            </h2>
            {/* animated underline */}
            <motion.div
              className="mx-auto mt-2 h-0.5 rounded-full bg-[#E4572E]"
              initial={{ width: 0 }}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-10">
            ...
            <motion.div
              className="w-full lg:w-5/12 shrink-0 flex justify-center py-2"
            ...
            >
              ...
              <motion.p
                ...
                className="text-xs sm:text-sm lg:text-base leading-relaxed text-[#2B1E17] mb-2"
              >
                Every year {" "}
              ...
              {paragraphs.slice(1).map((p, i) =>
                p.highlight ? (
                  <motion.div
                    key={i}
                    variants={paraVariant}
                    className="my-3 rounded-xl border-l-4 border-[#E4572E] bg-[#E4572E]/8 px-4 py-3"
                  >
