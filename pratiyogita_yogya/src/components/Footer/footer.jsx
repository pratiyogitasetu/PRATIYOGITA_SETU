        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div>
            <div className="inline-block bg-[#E4572E] rounded-lg px-3 py-1 mb-5">
              <h3 className="text-sm sm:text-base font-semibold text-[#FBF6EE]">Our Services</h3>
            </div>
          ...
          <div>
            <div className="inline-block bg-[#E4572E] rounded-lg px-3 py-1 mb-5">
              <h3 className="text-sm sm:text-base font-semibold text-[#FBF6EE]">About Us</h3>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-1.5 mb-5">
              <span className="text-sm text-[#E8D8C3]/80">For help and support:</span>
            ...
            <div className="inline-block bg-[#E4572E] rounded-lg px-3 py-1 mb-4">
              <h3 className="text-sm sm:text-base font-semibold text-[#FBF6EE]">Connect With Us</h3>
            </div>
        ...
        <div className="border-t border-[#E4572E]/30 mt-6 pt-3">
          <div className="flex flex-col sm:flex-row justify-between items-center text-[#E8D8C3]/80 text-xs sm:text-sm">
            ...
            <div className="mt-1 sm:mt-0">
              © {currentYear} |{" "}
              <Link to="/terms-and-conditions" className="underline hover:text-[#E4572E]">Terms & Conditions</Link>{" "}|{" "}
              <Link to="/refund-policy" className="underline hover:text-[#E4572E]">Refund Policy</Link>
            </div>
          </div>
        </div>
      </div>
