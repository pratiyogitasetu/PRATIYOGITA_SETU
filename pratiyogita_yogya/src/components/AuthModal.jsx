...
const AuthModal = ({ isOpen, onClose, initialMode = 'login' }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(getFirebaseAuthErrorMessage(err) || err.message || 'Authentication failed');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setError(getFirebaseAuthErrorMessage(err) || err.message || 'Google sign in failed');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={handleClose}
          className="absolute top-3 right-3 text-gray-400 hover:text-gray-700 hover:bg-gray-100 p-1.5 rounded-full transition-colors z-10 cursor-pointer"
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-2.5 bg-white text-gray-800 border border-gray-300 py-2 px-3 rounded-xl hover:bg-gray-50 hover:border-gray-400 shadow-2xs font-semibold text-xs sm:text-sm transition-all disabled:opacity-50 cursor-pointer"
        ...
        <form onSubmit={handleSubmit} className="space-y-2.5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-1.5 sm:py-2 text-xs sm:text-sm border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#E4572E] focus:border-transparent outline-none transition-all text-gray-900 placeholder:text-gray-400"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleInputChange}
                className="w-full pl-9 pr-10 py-1.5 sm:py-2 text-xs sm:text-sm border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#E4572E] focus:border-transparent outline-none transition-all text-gray-900 placeholder:text-gray-400"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-1 bg-[#E4572E] text-white py-2 px-4 rounded-xl font-bold text-xs sm:text-sm hover:bg-[#c9451e] shadow-xs hover:shadow-md transition-all disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer"
          >
            {loading
              ? 'Please wait...'
              : mode === 'login'
        ...
        <div className="mt-3.5 text-center text-xs text-gray-600">
          ...
          <button
            type="button"
            onClick={toggleMode}
            className="text-[#E4572E] hover:underline font-bold cursor-pointer"
          >
